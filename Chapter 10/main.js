        ...
        matrix: {
            add: function (a, b) {
                if (a.length == b.length && a[0].length == b[0].length) {
                    ...
                    return 'The matrix addition is undefined';
                }
            },
            sub: function (a, b) {
                if (a.length == b.length && a[0].length == b[0].length) {
                    ...
                    return 'The matrix substraction is undefined';
                }
            },
            mul: function (a, b) {
                if (a[0].length == b.length) {
                    ...
                    return 'The matrix multiplication is undefined';
                }
            },
            eye: function (size) {
                var eyeMatrix = [];
            ...
            dot: function (m, a) {
                if (m[0].length == a.length && m.length == 1) {
                    ...
                    return 'Please call the matrix multiplication'
                }
            },
            times: function (a, b) {
                if ((a.length == b.length) && (a[0].length == b[0].length)) {
                    ...
                    return 'The element-wise product is undefined';
                }
            }
        }
    }
